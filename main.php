...
if (isset($_POST['name'])) {
    ...
    $stmt = "INSERT INTO user (`name` ,`num`) VALUES ( '$name','$num')";
...
<head>
    ...
    - primary meta tags
  -->
    <title>Grilli - Amazing & Delicious Food Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime rerum illo
        porro numquam doloremque, officia, ea explicabo quisquam accusamus debitis pariatur. Tenetur ullam dolores
        beatae aliquam inventore. Voluptatum, eius consectetur!</title>
...
<body id="top">
    ...
    <div class="topbar">
        <div class="container">
            ...
            <div class="topbar-item">
                ...
                <span class="span">
                    Restaurant St, Egypt, Cairo 2023, EG
                </span>
            </div>
            ...
            <a href="tel:+11234567890" class="topbar-item link">
                ...
                <span class="span">01552242010</span>
            </a>
            ...
            <a href="mailto:booking@restaurant.com" class="topbar-item link">
                ...
                <span class="span">omarashrafothman1234@gmail.com</span>
            </a>
            ...
            <section class="hero text-center" aria-label="home" id="home">
                ...
                <ul class="hero-slider" data-hero-slider>
                    ...
                    <li class="slider-item active" data-hero-slider-item>
                        ...
                        <div class="slider-bg">
                            <img src="./assets/images/hero-slider-1.jpg" width="1880" height="950" alt=""
                                class="img-cover">
                        </div>
                    ...
                    <li class="slider-item" data-hero-slider-item>
                        ...
                        <div class="slider-bg">
                            <img src="./assets/images/hero-slider-2.jpg" width="1880" height="950" alt=""
                                class="img-cover">
                        </div>
                    ...
                    <li class="slider-item" data-hero-slider-item>
                        ...
                        <div class="slider-bg">
                            <img src="./assets/images/hero-slider-3.jpg" width="1880" height="950" alt=""
                                class="img-cover">
                        </div>
                    ...
                    <ul class="grid-list">
                            ...
                            <div class="service-card">
                                ...
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="./assets/images/service-1.jpg" width="285" height="336" loading="lazy"
                        ...
                        <li>
                            <div class="service-card">
                                ...
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="./assets/images/service-2.jpg" width="285" height="336" loading="lazy"
                        ...
                        <li>
                            <div class="service-card">
                                ...
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="./assets/images/service-3.jpg" width="285" height="336" loading="lazy"
            ...
            <section class="section about text-center" aria-labelledby="about-label" id="about">
                <div class="container">
                    ...
                    <div class="about-content">
                        ...
                        <a href="tel:+804001234567" class="body-1 contact-number hover-underline">+20 1552242010</a>
                    ...
                    <div class="form reservation-form bg-black-10">
                        ...
                        <form action="" class="form-left" method="POST">
                            ...
                            <p class="form-text text-center">
                                Booking request <a href="tel:+88123123456" class="link">01552242010</a>
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="tel" name="num" placeholder="Phone Number" autocomplete="off"
                                    class="input-field">
                            </div>
                        ...
                        <div class="form-right text-center"
                            ...
                            <a href="tel:+88123123456" class="body-1 contact-number hover-underline">01552242010</a>
                        ...
                        <li>
                            <div class="event-card has-before hover:shine">
                                ...
                                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                                    ...
                                    <time class="publish-date label-2" datetime="2022-09-08">14/12/2023</time>
                                </div>
        ...
        <div class="container">
            ...
            <div class="footer-top grid-list">
                ...
                <div class="footer-brand has-before has-after">
                    ...
                    <a href="mailto:booking@grilli.com" class="body-4 contact-link">omarashrafothman1234@gmail.com</a>

                    <a href="tel:+88123123456" class="body-4 contact-link">Booking Request : 01552242010</a>
                ...
                <ul class="footer-list">
                    ...
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=100030223352000"
                            class="label-2 footer-link hover-underline">Facebook</a>
                    </li>

                    <li>
                        <a href="https://www.instagram.com/maro.ashraf/"
            ...
            <div class="footer-bottom">
                ...
                <p class="copyright">
                    &copy; 2023 Grilli. All Rights Reserved | Crafted by <a
                        href="https://github.com/omarashrafothman?tab=repositories" target="_blank" class="link">omar
                        othman</a>
                </p>
  ...
  -->
    ...
    (function() {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/639b1c46b0d6371309d49386/1gkauctbc';
        s1.charset = 'UTF-8';
